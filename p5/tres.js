...
var quantity = [1,0,1,0,0,0,0,2,5,7]
...
function draw() {
  ...
  for(var x = 0; x <= years.length; x++){
    ...
    rect((height/3),  ((height/(years.length+5))*(x+0.7)), quantity[x]*30, 26);
    //re-defino el blanco
    fill(255);
    ...
    text(years[x],((height/7)+12) , ((height/(years.length+8.5))*(x+1)),((windowWidth/2)-50),100);
  }
}
